...
class GarmentConfig:
    def __init__(self,usd_path:str="./data/Cloth-Simulation/Assets/Garment/Dress/Long_LongSleeve/DLLS_Dress355/DLLS_Dress355_obj.usd",pos:Union[torch.Tensor,np.ndarray]=np.array([0.5,-0.5,0.3]),ori:Union[torch.Tensor,np.ndarray]=np.array([0,0,np.pi/2]),scale:np.ndarray=np.array([0.005,0.005,0.005]),visual_material_usd:str="data/Cloth-Simulation/Assets/Material/linen_Beige.usd",particle_contact_offset:float=0.02):

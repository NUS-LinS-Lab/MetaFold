...
class Garment:
    def __init__(self,world:World,garment_config:GarmentConfig,particle_system:ParticleSystem=None):
        ...
        self.garment_mesh_prim_path=self.garment_prim_path+"/initial/mesh"
    ...
    def get_velocities(self):
        return self.particle_controller.get_velocities()
    
    def set_velocities(self,velocities):
        return self.particle_controller.set_velocities(velocities)
